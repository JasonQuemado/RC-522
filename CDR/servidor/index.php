...
//INTENTO 3
    ...
    $orderedWeekdays = ['Mon','Tue','Wed','Thu','Fri','Sat','Sun'];
    $dayIndex = array_search($currentDay, $orderedWeekdays);

    $minuteIndex = $dayIndex * 10000 + $currentHour * 60 + $currentMinute;
    
    $sql .= " ORDER BY
        CASE WHEN sort_index >= $minuteIndex THEN 0 ELSE 1 END,
        sort_index ASC";
}
